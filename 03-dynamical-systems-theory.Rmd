...
* What happens if you increase the rate of increase ($t_i$) from 0.05 to 0.08?
...
* Which grey shade corresponds to a stable, and which to an unstable equilibrium?
<!-- Dark-grey = stable equilibrium, light-grey unstable equilibrium -->


* Assume the initial budworm population is close to zero and $r_i$ equals 0.05. A small perturbation causes $B$ to increase. (a) What will the final population density be after some time? (b) What will happen with the population density if $r_i$ increases from 0.05 to 0.06?
<!-- (a) B = 1, (b) B = 8 -->
...
The Figure above shows a critical transition of the population occurring at about 190. Let's see if we can predict this transition by only looking at the data prior to this moment in time. To do this, let's truncate our data set, excluding all data after 190.
