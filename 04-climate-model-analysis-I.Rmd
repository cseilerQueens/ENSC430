...
### (2) Linear trend of consecutive dry days
...
plot(trend, col = my.col, 
  type = "continuous",
  breaks = breaks,
  main = "Consecutive Dry Days Trend (2015-2100)")
map("world2", add = TRUE)
```

### (3) Consecutive dry days time series
...
### (4) Analysis of an extreme climate index of your choice and region
* Choose a different [ClimInd](https://cran.r-project.org/web/packages/ClimInd/index.html) climate index
* Compute the future trend of this index for another region of the globe
