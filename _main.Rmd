...
|6 | Fri, Oct 11 | [Climate Model Analysis (III): Causal Inference](https://drive.google.com/file/d/1BNwSVvtdim9-Cld86TVo-tIuIC2UBP4M/view?usp=sharing)| [vars](https://cran.r-project.org/web/packages/vars/index.html)| [Papagiannopoulou et al (2017)](https://iopscience.iop.org/article/10.1088/1748-9326/aa7145/meta)|
|7 | Fri, Oct 18 | Reading Week | - | - |
|8 | Fri, Oct 25 | [Global Earth Observations (I): Satellite Data](https://drive.google.com/file/d/1XmdoHExibtMsIMtHv55FurtGqoqlMo3-/view?usp=sharing)| [terra](https://cran.r-project.org/web/packages/terra/index.html)| [Yan et al (2013)](https://www.nature.com/articles/nclimate1908)|
...
Repeat the analysis, calculating ecosystem resilience for Australia. For this example, do not mask out low EVI values. The coordinates are 110 to 160 longitude and -45 to -10 latitude, so ```data <- crop(x=data, y = c(110, 160, -45, -10))```. Your result should look similar to the Figure below. Goo luck!
...
data <- subset(data, 12:287)
# Let's focus on Australia
# data <- crop(x=data, y = c(220, 270, 48, 70))
